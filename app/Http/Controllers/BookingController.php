...
class BookingController extends Controller
{
    ...
    public function booking(Request $request){  
        ...
        $booking = new Booking;
        $booking->customer_id=Session::get('customer_id');
    ...
    public function update(Request $request){
        ...
        if($booking->booking_status==4){
            ...
            if($request['booking_status']==1){
                $tour->tour_slot=$request['tour_slot']-$request['number_slot'];
            }
            ...
            // $customer = Booking::where('customer_id',$request['customer_id'])->get();
    ...
    public function save_customer_review(Request $request){
        ...
        $review->save();
        $booking->save();
        return view('Page_views.ReviewPage');
    }
    ...
    public function delete_booking($booking_code){
        ...
        toastr()->success('Hủy thành công!', 'Congrats', ['timeOut' => 2000]);
        return view('Page_Views.Account.Profile');
   }
}
