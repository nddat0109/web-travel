				...
				?>
                    <div class="col-lg-8 col-md-8 mb-2 ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 mb-2 icon_tour">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#12519A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"></polygon><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 mb-2 icon_tour">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#12519A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                        <span class="tour_name">{{__('Khởi hành')}}: </span> <b>
                            {{date('d-m-Y', strtotime($tour->tour_date))}}</b>
                            </div>
                            <div class="col-lg-6 col-md-6 mb-2 icon_tour">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#12519A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                ...
                <div class="col-lg-8 col-md-9">
                    <div class="contact_join">
                        ...
                        <form role="form" action="{{URL::to('/booking')}}" method="post">
                            ...
                            <input type="hidden" id ="tour_slot" name="tour_slot" value="{{$tour->tour_slot}}">
                            ...
                            <div class="mt-10" style="margin-top:20px;">
                                <div class="submit_btn">
                                    <button class="boxed-btn4" id="book" type="submit">{{__('Đặt ngay')}}</button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="container">
                            <div class="cost_from">
                                <div class="sample-text">
                                    {{__('Mang lại những trải nghiệm tuyệt vời cho quý khách')}}
...
<script type="text/javascript">
 $(document).ready(function() {
    ...
    $("#total").click(function() {
     ...
     $("#book").click(function(){
        var tour_slot = $("#tour_slot").val();
        var child = $("#child").val();
        var adult = $("#adult").val();
        var ifant = $("#ifant").val();
        var total = (adult*1+child*1+ifant*1);
         $('#total').val(total);
         $('#tour_slot').val(tour_slot);
        if(tour_slot < total){
            alert("Quá số lượng");
