            ...
            <div class="col-lg-12 col-md-9">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 mb-2 icon_tour">
                        ...
                        <span class="tour_name">{{__('Khoảng thời gian')}}: </span><span> {{$tour->tour_day}} {{__('ngày')}}
                            {{$tour->tour_night}} {{__('đêm')}}</span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6 mb-2 icon_tour">
                        ...
                        <span class="tour_name">{{__('Khởi hành')}}: </span> <span> {{$tour->tour_departure}}</span>
                    </div>
                    <div class="col-lg-6 col-md-6 mb-2 icon_tour">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24"
                            viewBox="0 0 172 172" style=" fill:#000000;">
                        ...
                        <span class="tour_name">{{__('Điểm đến')}}: </span> <span> {{$tour->tour_arrival}}</span>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
                    ...
                    <div class="contact_join">
                        ...
                        <div class="mt-10">
                            <div class="form-group row">
                                <label 
                                    for="example-datetime-local-input" class="col-2 col-form-label">Ngày đi</label>
                                <div class="col-10">
                        ...
                        <div class="mt-10">
                            <textarea disabled class="single-textarea"
                                value="{{$booking->booking_customer_message}}" onfocus="this.placeholder = ''"
                        ...
                        <div class="container">
                            <div class="cost_from">
                                <div class="sample-text">
                                    <h3><b>{{__('BÌNH LUẬN VÀ ĐỂ LẠI ĐÁNH GIÁ')}}</b></h3>
                                    <sup>{{__('Nhấp vào xếp hạng để gửi')}}</sup>
            ...
            <div class="col-lg-6 col-md-9">
                ...
                <div class="section-top-border" style="padding-top: 0px;">
                    <h3>{{__('Một vài hình ảnh về chuyến đi')}}</h3>
