        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-9">
                <div class="contact_join">
                    ...
                    <form style ="border: 1px solid; padding: 30px" action="{{URL::to('/add-customer')}}" id="formLogin" method="POST">
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="col-lg-12 ">
                                <h4>Số điện thoại</h4>
                                <div class="single_input">
                                    <input type="phone" class="form-control @error('customer_phone_number') is-invalid @enderror " id="InputPhone" placeholder="Enter Phone Number"
