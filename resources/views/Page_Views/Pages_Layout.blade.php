...
<head>
    ...
    <link rel="icon" type="image/png" size="20x10" href="{{asset('Pages/img/paradise.png')}}">
                    ...
                    <div class="header_bottom_border">
                        <div class="row align-items-center">
                            <div class="col-xl-2 col-lg-2">
                                <div class="logo">
                                    <a href="{{URL::to('/')}}">
                                        <img style=" " src="{{asset('Pages/img/paradise.png')}}" alt="">
                                    </a>
                                </div>
                            </div>
        ...
        <div class="footer_top">
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            ...
                            <p>Số 3 Phố Cầu Giấy, Hanoi, Vietnam <br>
                                <a href="#">+84 024 3766 3311</a> <br>
                                <a href="#">paradise@gmail.com</a>
                            </p>
            ...
            <div class="container">
                <a id="back-to-top" href="#" class="btn btn-light btn-lg back-to-top" role="button"
                    style=" background-color: #12519A; border: none; position: fixed;bottom: 25px;right: 25px;display: none;"><i
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <p class="copy_right text-center">
                            ...
                            </script> All rights reserved | <a href="#" target="_blank">Paradise </a>
                        </p>
                    </div>
                </div>
            </div>
