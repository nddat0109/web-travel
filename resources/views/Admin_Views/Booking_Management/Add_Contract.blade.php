                ...
                <form role="form" action="{{URL::to('/save-contract')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    <input required onkeypress="return fun_AllowOnlyAmountAndDot(this.id)" name="contract_total_price" id="only_numb" class="form-control" value="{{ $booking->booking_total_price }} ">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
