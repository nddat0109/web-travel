            ...
            <form role="form" action="{{URL::to('/update-booking')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                                <input  min="0" type="hidden" class="form-control input" value="{{$booking->tour_slot}}"
                                name="tour_slot">
                            <div class="form-group">
                                <label for="com1" class="control-label col-form-label">{{__("Keeping slots")}}</label>
                                <input  min="0" type="number" class="form-control input" value="{{$booking->booking_customer_adult+$booking->booking_customer_child+$booking->booking_customer_ifant}}"
                                    name="number_slot">
