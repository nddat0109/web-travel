...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('Pages/img/paradise.png')}}">
    <title>Admin</title>
    <!-- Custom CSS -->
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">
                    ...
                    <b class="logo-icon">
                        ...
                        <!-- Dark Logo icon -->
                        <img src="{{asset('Admins/img/logoad.png')}}" alt="homepage" class="dark-logo" />
                        <!-- Light Logo icon -->
                        <img src="{{asset('Admins/img/logoad.png')}}" alt="homepage" class="light-logo" />
                    </b>
...
?>
                    ...
                    {{-----------------------------------------------------------------------------------------}}
                    {{--Start tour manager--}}
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÍ HỆ THỐNG TOUR')}}</span></li>
                    ...
                    <li  class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-content-save-all"></i><span class="hide-menu">{{__('HỢP ĐỒNG')}} </span></a>
                        <ul aria-expanded="false" class="collapse  first-level">
                            ...
                            <li class="sidebar-item">
                            <a href="{{URL::to('/list-contract/2')}}" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> {{__('Hợp đồng đang tiến hành')}} </span></a>
                    ...
                    <li class="nav-small-cap"><i class="mdi mdi-dots-horizontal"></i> <span class="hide-menu">{{__('QUẢN LÝ TOUR RIÊNG')}}</span></li>
        ...
        <footer class="footer text-center">
            <div class="col-xl-12">
                <p class="copy_right text-center">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  <a href="http://127.0.0.1:8000/" target="_blank">Paradise </a>
                </p>
            </div>
        </footer>
        <!-- ============================================================== -->
