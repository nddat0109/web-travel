    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{__('Thêm loại hình du lịch')}}</h4>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{__('Loại du lịch')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <form role="form" action="{{URL::to('/save-type-tour')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex no-block align-items-center">
                            <h4 class="card-title">{{__('THÊM LOẠI DU LỊCH')}}</h4>
                        </div>
                        <div class="row">
                            <div class="col-12">
